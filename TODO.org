...
* TODO 'better lambda'
* TODO keywords
* TODO use meta reader to save source location info for top-level forms
...
* TODO save-snapshot-and-exit
* TODO switch over to userspace print function
* TODO run tests using built img instead of repeated cold boots
