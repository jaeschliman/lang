...
(define (check3 a b)
  (let ((a (if (fixnum? a) (#/lang/i->b a) a))
    ...
    (#/lang/%print `((> a b) = ,(#/lang/>b a b)))
    (#/lang/%print `((= a b) = ,(#/lang/=b a b)))
    (#/lang/%print `((< b a) = ,(#/lang/<b b a)))
    (#/lang/%print `((> b a) = ,(#/lang/>b b a)))
    (#/lang/%print `((= b a) = ,(#/lang/=b b a)))
    (#/lang/%print `(sanity check (#f #f #t #f #f #t) = ,(list
                                                          (#/lang/<b a a)
                                                          (#/lang/>b a a)
                                                          (#/lang/=b a a)
                                                          (#/lang/<b b b)
...
(check3 -1 1)
(check3 -2 2)
(check3 -36893488147419103232 0)
(check3 36893488147419103232 0)
(check3 -36893488147419103232 36893488147419103232)
(check3 -36893488147419103232 -1)
(check3 36893488147419103232 -1)
(check3 -36893488147419103232 1)
(check3 36893488147419103232 1)
(check3 -30000000000000000000 -30000000000000000001)
(check3 30000000000000000000 30000000000000000001)
