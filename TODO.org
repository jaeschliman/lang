...
* TODO recover from image snapshot call
* TODO snapshot support for graphics sessions
...
* TODO support for command line args in image and boot
...
* TODO get rid of the istream nonsense
