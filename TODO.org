...
* TODO blit from quad to quad images
...
* IN-PROGRESS write a compiler/assembler in userspace 
...
* TODO consider a better way of emitting side-effectful calls
...
* DONE asm: %nlambda
* DONE asm: %let
* TODO asm: recursive definitions (define, named let)
  keep TCO local loops from allocating
* TODO asm: looping contruct
* TODO asm: tagbody
* TODO asm: dedupe lits
* DONE asm: set!
...
* TODO asm: optimize self tail calls into banging on args and a jump
* TODO asm: provide compiler notes and warnings
* IN-PROGRESS eventually swap in the new compiler
